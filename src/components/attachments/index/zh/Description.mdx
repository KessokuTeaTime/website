...
<sub>
  <b>结束 TEA TIME（結束ティータイム）</b>是由
  <b>[结束乐队（結束バンド）](https://bocchi-the-rock.fandom.com/wiki/Kessoku_Band)</b>的{' '}
  <b>结束（来自番剧[孤独摇滚](https://bocchi.rocks/)）=</b>和
  <b>[放学后 TEA TIME（放課後ティータイム）](https://k-on.fandom.com/wiki/Ho-kago_Tea_Time)</b>的{' '}
  <b>TEA TIME（ティータイム）（来自番剧[轻音少女 K-ON!](https://www.tbs.co.jp/anime/k-on/)） </b>
  组合而成的名称。
</sub>
